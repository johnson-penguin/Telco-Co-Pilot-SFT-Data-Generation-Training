...
def main():
    ...
    input_dir = os.path.join(PROJECT_ROOT, "3_defined_input_format", "new_defind_format_du_1113_20_case")
    output_dir = os.path.join(PROJECT_ROOT, "4_filter_out_the_error_log", "filter_defind_format_du_1113_20_case")
