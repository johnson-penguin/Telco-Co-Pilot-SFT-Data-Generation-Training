...
def parse_args() -> argparse.Namespace:
    ...
    default_input_root = os.path.join(base_dir, "1_after_processing(clean)", "filter_defind_format_50_case")
    default_input_dir = default_input_root  # backward compatible default
    default_output = os.path.join(base_dir, "2_prompt_with_json", "filter_defind_format_50_with_prompt_1")
