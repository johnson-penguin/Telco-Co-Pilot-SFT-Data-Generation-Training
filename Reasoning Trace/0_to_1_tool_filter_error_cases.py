...
def main():
    ...
    input_dir = os.path.join(base_dir, "0_input_data(unclean)", "new_defind_format_1014_800_case")
    output_dir = os.path.join(base_dir, "1_after_processing(clean)", "filter_defind_format_1014_800_case")
