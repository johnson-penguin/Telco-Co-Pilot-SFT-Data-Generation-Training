...
JSON File
{
  "misconfigured_param": "MACRLCs[0].local_n_address=abc.def.ghi.jkl",
  "logs": {
    "CU": [
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x4c805d0)",
      ...
      "\u001b[0m[F1AP]   F1-C DU IPaddr abc.def.ghi.jkl, connect to F1-C CU 127.0.0.5, binding GTP to abc.def.ghi.jkl",
      ...
      "getaddrinfo(abc.def.ghi.jkl) failed: Name or service not known",
      "\u001b[1;31m[GTPU]   can't create GTP-U instance",
      "\u001b[0m",
      "Exiting execution",
      "[GTPU]   Created gtpu instance id: -1",
      "\u001b[0mCMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/du_case_101.conf\" ",
