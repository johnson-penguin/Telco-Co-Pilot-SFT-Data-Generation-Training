...
JSON File
{
  "misconfigured_param": "MACRLCs[0].remote_n_address=",
  "logs": {
    "CU": [
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x380b5d0)",
      ...
      "\u001b[0m[F1AP]   F1-C DU IPaddr 127.0.0.3, connect to F1-C CU , binding GTP to 127.0.0.3",
      ...
      "",
      "Exiting execution",
      "CMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/du_case_143.conf\" ",
