...
JSON File
{
  "misconfigured_param": "plmn_list[0].mnc_length=5",
  "logs": {
    "CU": [
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x4dea5d0)",
      ...
      "\u001b[0m[CONFIG] config_check_intval: mnc_length: 5 invalid value, authorized values:",
      "        2 3 ",
      "\u001b[1;31m[ENB_APP]   [CONFIG] config_execcheck: section gNBs.[0].plmn_list.[0] 1 parameters with wrong value",
      "\u001b[0mCMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/du_case_04.conf\" ",
