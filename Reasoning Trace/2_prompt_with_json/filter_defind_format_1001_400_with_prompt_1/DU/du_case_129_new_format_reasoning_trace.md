...
JSON File
{
  "misconfigured_param": "RUs[0].nb_rx=invalid_string",
  "logs": {
    "CU": [
      ...
      "\u001b[0m[NR_RRC]   Received F1 Setup Request from gNB_DU 3584 (gNB-Eurecom-DU) on assoc_id 3689",
      ...
      "\u001b[0m[F1AP]   Received SCTP state 1 for assoc_id 3689, removing endpoint",
      "\u001b[0m[NR_RRC]   releasing DU ID 3584 (gNB-Eurecom-DU) on assoc_id 3689",
      "\u001b[0m"
    ],
    "DU": [
      ...
      "\u001b[0m[PHY]   Starting RU 0 (,synch_to_ext_device) on cpu 25",
      ...
      "\u001b[0m[PHY]   fp->N_RB_SL=0",
      "\u001b[0m[PHY]   Setting RF config for N_RB 106, NB_RX 1, NB_TX 4",
      ...
      "\u001b[0mCMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/du_case_129.conf\" ",
      ...
      "Initializing random number generator, seed 9934917990828690645",
