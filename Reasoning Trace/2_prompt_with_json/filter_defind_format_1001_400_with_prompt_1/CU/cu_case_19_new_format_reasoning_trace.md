...
JSON File
{
  "misconfigured_param": "gNBs.local_s_address=invalid_ip_format",
  "logs": {
    "CU": [
      ...
      "\u001b[0m[F1AP]   F1AP_CU_SCTP_REQ(create socket) for invalid_ip_format len 18",
      "\u001b[0m[GTPU]   Initializing UDP for local address invalid_ip_format with port 2152",
      "\u001b[0m",
      "Assertion (status == 0) failed!",
      "In sctp_create_new_listener() ../../../openair3/SCTP/sctp_eNB_task.c:617",
      "getaddrinfo() failed: Name or service not known",
      "",
      "Exiting execution",
      "CMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/cu_case_19.conf\" ",
      ...
      "Reading 'GNBSParams' section from the config file",
      "Reading 'NETParams' section from the config file",
      "../../../openair3/SCTP/sctp_eNB_task.c:617 sctp_create_new_listener() Exiting OAI softmodem: _Assert_Exit_"
    ],
    "DU": [
      "[UTIL]   running in SA mode (no --phy-test, --do-ra, --nsa option present)",
      "\u001b[0m[OPT]   OPT disabled",
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x3dce5d0)",
