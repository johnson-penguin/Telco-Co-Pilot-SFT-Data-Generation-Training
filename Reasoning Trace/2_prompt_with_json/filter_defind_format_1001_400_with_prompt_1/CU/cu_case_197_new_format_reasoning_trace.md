...
JSON File
{
  "misconfigured_param": "gNBs.NETWORK_INTERFACES.GNB_IPV4_ADDRESS_FOR_NG_AMF=abc.def.ghi.jkl",
  "logs": {
    "CU": [
      ...
      "\u001b[0m[GNB_APP]   Parsed IPv4 address for NG AMF: abc.def.ghi.jkl",
      ...
      "",
      "Exiting execution",
      "CMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/cu_case_197.conf\" ",
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x53855d0)",
  ...
  "network_config": {
    "cu_conf": {
      ...
      "gNBs": {
        ...
        "NETWORK_INTERFACES": {
          "GNB_IPV4_ADDRESS_FOR_NG_AMF": "abc.def.ghi.jkl",
