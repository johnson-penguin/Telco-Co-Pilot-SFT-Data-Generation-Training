...
JSON File
{
  "misconfigured_param": "security.drb_integrity=invalid_enum_value",
  "logs": {
    "CU": [
      ...
      "\u001b[0m\u001b[1;31m[RRC]   in configuration file, bad drb_integrity value 'invalid_enum_value', only 'yes' and 'no' allowed",
      "\u001b[0mCMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/cu_case_165.conf\" ",
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x3a6f5d0)",
  ...
  "network_config": {
    "cu_conf": {
      ...
      "security": {
        ...
        "drb_ciphering": "yes",
        "drb_integrity": "invalid_enum_value"
      },
      "log_config": {
