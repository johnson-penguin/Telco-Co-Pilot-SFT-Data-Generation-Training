...
JSON File
{
  "misconfigured_param": "gNBs.gNB_name=12345",
  "logs": {
    "CU": [
      ...
      "\u001b[0m[GNB_APP]   F1AP: gNB_CU_name[0] OAIgNodeB",
      ...
      "\u001b[0m[NGAP]   Registered new gNB[0] and home gNB id 0",
      ...
      "\u001b[0m[GTPU]   Created gtpu instance id: 93",
      "\u001b[0m[UTIL]   threadCreate() for TASK_GNB_APP: creating thread with affinity ffffffff, priority 50",
      "\u001b[0m\u001b[1;31m[NR_RRC]   PLMNs received from CUUP (mcc:1, mnc:1) did not match with PLMNs in RRC (mcc:0, mnc:0)",
      "\u001b[0m[NR_RRC]   Triggering E1AP Setup Failure for transac_id 0, assoc_id -1",
      ...
      "\u001b[0m[NR_RRC]   Received F1 Setup Request from gNB_DU 3584 (gNB-Eurecom-DU) on assoc_id 2451",
      "\u001b[0m\u001b[1;31m[NR_RRC]   PLMN mismatch: CU 000.0, DU 00101",
      "\u001b[0m\u001b[93m[SCTP]   Received SCTP SHUTDOWN EVENT",
      "\u001b[0m[F1AP]   Received SCTP state 1 for assoc_id 2451, removing endpoint",
      "\u001b[0m\u001b[93m[NR_RRC]   no DU connected or not found for assoc_id 2451: F1 Setup Failed?",
      "\u001b[0m"
    ],
    "DU": [
      "[UTIL]   running in SA mode (no --phy-test, --do-ra, --nsa option present)",
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x406b5d0)",
      ...
      "\u001b[0m[GTPU]   Created gtpu instance id: 94",
      "\u001b[0m\u001b[1;31m[MAC]   the CU reported F1AP Setup Failure, is there a configuration mismatch?",
