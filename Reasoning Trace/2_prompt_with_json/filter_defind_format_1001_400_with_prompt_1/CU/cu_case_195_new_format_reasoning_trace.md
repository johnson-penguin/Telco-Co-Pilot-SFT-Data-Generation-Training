...
JSON File
{
  "misconfigured_param": "gNBs.plmn_list.snssaiList.sst=-1",
  "logs": {
    "CU": [
      ...
      "\u001b[0m[CONFIG] config_check_intrange: sst: -1 invalid value, authorized range: 0 255",
      "\u001b[1;31m[ENB_APP]   [CONFIG] config_execcheck: section gNBs.[0].plmn_list.[0].snssaiList.[0] 1 parameters with wrong value",
      "\u001b[0mCMDLINE: \"/home/oai72/oai_johnson/openairinterface5g/cmake_targets/ran_build/build/nr-softmodem\" \"--rfsim\" \"--sa\" \"-O\" \"/home/oai72/Johnson/auto_run_gnb_ue/error_conf/cu_case_195.conf\" ",
    ...
    "DU": [
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x47855d0)",
