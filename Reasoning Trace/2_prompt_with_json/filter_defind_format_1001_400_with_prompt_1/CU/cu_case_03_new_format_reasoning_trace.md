...
JSON File
{
  "misconfigured_param": "gNBs.plmn_list.mcc=999",
  "logs": {
    "CU": [
      ...
      "\u001b[0m\u001b[1;31m[NGAP]   Received NG setup failure for AMF... please check your parameters",
      ...
      "\u001b[0m[GNB_APP]   [gNB 0] Received NGAP_REGISTER_GNB_CNF: associated AMF 0",
      ...
      "\u001b[0m[NR_RRC]   Received F1 Setup Request from gNB_DU 3584 (gNB-Eurecom-DU) on assoc_id 2075",
      "\u001b[0m\u001b[1;31m[NR_RRC]   PLMN mismatch: CU 999.01, DU 00101",
      "\u001b[0m\u001b[93m[SCTP]   Received SCTP SHUTDOWN EVENT",
      "\u001b[0m[F1AP]   Received SCTP state 1 for assoc_id 2075, removing endpoint",
      "\u001b[0m\u001b[93m[NR_RRC]   no DU connected or not found for assoc_id 2075: F1 Setup Failed?",
      "\u001b[0m"
    ],
    "DU": [
      "[UTIL]   running in SA mode (no --phy-test, --do-ra, --nsa option present)",
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x44725d0)",
