...
JSON File
{
  ...
  "logs": {
    "CU": [
      ...
      "\u001b[0m[NR_RRC]   Received F1 Setup Request from gNB_DU 3584 (gNB-Eurecom-DU) on assoc_id 1820",
      "\u001b[0m\u001b[1;31m[NR_RRC]   PLMN mismatch: CU 999.01, DU 00101",
      "\u001b[0m\u001b[93m[SCTP]   Received SCTP SHUTDOWN EVENT",
      "\u001b[0m[F1AP]   Received SCTP state 1 for assoc_id 1820, removing endpoint",
      "\u001b[0m\u001b[93m[NR_RRC]   no DU connected or not found for assoc_id 1820: F1 Setup Failed?",
      "\u001b[0m"
    ],
    "DU": [
      "[UTIL]   running in SA mode (no --phy-test, --do-ra, --nsa option present)",
      ...
      "\u001b[0m[NR_PHY]   Registered with MAC interface module (0x3b0a5d0)",
