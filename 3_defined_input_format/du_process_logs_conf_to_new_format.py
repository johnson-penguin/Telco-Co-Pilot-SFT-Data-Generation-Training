...
def main():
    """Main function: merge specific DU runlogs and configs for 1014_800 batch."""
    conf_root = Path(r"C:/Users/bmwlab/Desktop/cursor_gen_conf/1_confgen_workspace/du_conf_1009_200")
    runlog_root = Path(r"C:/Users/bmwlab/Desktop/cursor_gen_conf/2_runlog_workspace/logs_batch_run_1009_200")
    output_dir = Path(r"C:/Users/bmwlab/Desktop/cursor_gen_conf/3_defined_input_format/new_defind_format_1009_200_case")

    output_dir.mkdir(parents=True, exist_ok=True)

    print("Scanning du_conf_1014_800 for cases_delta.json...")
    delta_index = build_cases_delta_index(conf_root)
    print(f"Found {len(delta_index)} delta entries")

    print("Scanning logs_batch_run_1014_800 for tail100_summary.json directories...")
    ...
    for case_dir in case_dirs:
        ...
        if modified_key or error_value:
            ...
            misconfigured_param = "Asn1_verbosity=debug"
