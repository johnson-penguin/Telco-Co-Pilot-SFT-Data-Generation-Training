...
DEFAULT_ERROR_CASES_JSON = os.path.normpath(os.path.join(SCRIPT_DIR, "..", "1_conf", "du_conf_1001_200", "json", "cases_delta.json"))
DEFAULT_OUTPUT_DIR = os.path.normpath(os.path.join(SCRIPT_DIR, "..", "1_conf", "du_conf_1001_200", "conf"))
