...
def main() -> None:
    ...
    DEFAULT_INPUT = PROJECT_ROOT / "1_confgen_workspace" / "0_workable_conf" / "cu_conf"
    DEFAULT_OUTPUT = PROJECT_ROOT / "1_confgen_workspace" / "0_workable_json_conf" / "cu_gnb_json"
